	...
	<u-popup :show="show" @close="closeHandler">
		<view class="u-picker">
			<u-toolbar v-if="showToolbar" :cancelColor="cancelColor" :confirmColor="confirmColor"
				...
				:sukiyou_toolbar="sukiyou_toolbar">
			</u-toolbar>
			...
			<view
			v-if="sukiyou_toolbar"
			class="u-picker--sukiyou"
			>
				<u-button class="can" :text="cancelText"  @tap="cancel"></u-button>
				<view class="pp"></view>
				<u-button class="con" :text="confirmText"  @tap="confirm"></u-button>
			</view>
		</view>
	</u-popup>
</template>
